...
<div id="content_list">@include('admin.support_seller.list')</div>
<div id="content_detail"></div>
@section('js') 
 <script src="{{asset('admin/assets/js/datatable/tables/ticket-seller.js')}}"></script>
...
<script>
  ...
  //CHAT
        $('body').on('click','.viewBtn',function(){
            ...
            $.ajax({
                type: "GET",
               url: '{{url("admin/support/chat")}}/'+id+"/chat",
...
//Create
        $('body').on('click','.createbtn',function(){
            ...
            $.ajax({
                type: "GET",
               url: '{{url("admin/support/create")}}/'+id+"/view",
                success: function (data) {
     ...
     function submitThisForm(id){
       ...
       $.ajax({
           type: "POST",
           url: '{{url("admin/support/create")}}/'+id+"/create",
