<?php    
if($product){ 
    $prices         =   $product->prdPrice;         $prdAssAttrs    =   $product->assignedAttrs($product->id);
    ...
    $status         =   $product->is_active;        $taxId          =   $product->tax_id;           $price          =       $prices->price;
    ...
    $adminPrd = $id =   0; $commi = $prdType = $prdName = $catId = $subCatId = $brandId = $sDesc = $desc = $content = $price = $sPrice = $taxId = $stDate = $edDate = ''; 
    $status         =   1; $sellerId = $seller->seller_id; $sellCkd = true; $adminCkd = false; $prdAssAttrs = []; $id = 0;
}
            ...
            {{ Form::open(array('url' => "admin/seller/product/save", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                ...
                <div class="tabs-menu mb-4">
                    <ul class="nav panel-tabs">
                        ...
                        <li><a href="#tab5" data-toggle="tab" id="nav_tab_5" class="no-disp"><span>Associative Products</span></a></li>
                   </ul>
                </div>
                <div class="row panel-body tabs-menu-body">
                    <div class="tab-content col-12">
                        ...
                        <div class="tab-pane asso" id="tab5"></div>
                    </div>
                </div>
                <div class="col-lg-12">
