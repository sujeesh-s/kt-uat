$(document).ready(function () {
    ...
    $(".stockprice-stock tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".stockprice-stock").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "Kangtao - Stock List",
                titleAttr: "Export to Excel",
                filename: "Kangtao_stockprice-stock",
                exportOptions: {
...
//            }  
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ stock",
            infoEmpty: "Showing 0 to 0 of 0 stock",
            infoFiltered: "(filtered from _MAX_ total stock)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ stock",
    ...
    $("thead tr th:first-child, thead tr th:last-child").removeClass("sorting_desc");
     $('#stockprice-stock td').css('white-space','initial');
});