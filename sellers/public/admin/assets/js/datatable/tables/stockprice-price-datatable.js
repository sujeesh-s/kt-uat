$(document).ready(function () {
    ...
    $(".stockprice-price tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".stockprice-price").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "Kangtao - Price List",
                titleAttr: "Export to Excel",
                filename: "Kangtao_stockprice-price",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No Price found",
            info: "Showing _START_ to _END_ of _TOTAL_ price",
            infoEmpty: "Showing 0 to 0 of 0 price",
            infoFiltered: "(filtered from _MAX_ total price)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ price",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching price found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
    ...
    $("thead tr th:first-child, thead tr th:last-child").removeClass("sorting_desc");
     $('#stockprice-price td').css('white-space','initial');
});