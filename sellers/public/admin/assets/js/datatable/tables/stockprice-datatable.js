$(document).ready(function () {
    ...
    $(".stockprice tfoot th").each(function () {
        var title = $(this).text();
        $(this).html('<input type="text" placeholder="' + title + '" />');
    });

    var table = $(".stockprice").DataTable({
        pageLength: 10,
        rowReorder: false,
        colReorder: true,
        paging: true,
        ...
        buttons: [
            ...
            
            {
                ...
                title: "Kangtao - Stock/Price List",
                titleAttr: "Export to Excel",
                filename: "Kangtao_stockprice",
                exportOptions: {
...
//            }  
        ...
        language: {
            decimal: "",
            emptyTable: "No Stock/Price found",
            info: "Showing _START_ to _END_ of _TOTAL_ stock/price",
            infoEmpty: "Showing 0 to 0 of 0 stock/price",
            infoFiltered: "(filtered from _MAX_ total stock/price)",
            infoPostFix: "",
            thousands: ",",
            lengthMenu: "Show _MENU_ stock/price",
            loadingRecords: "Loading...",
            processing: "Processing...",
            search: "Search:",
            zeroRecords: "No matching stock/price found",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
    ...
    $("thead tr th:first-child, thead tr th:last-child").removeClass("sorting_desc");
     $('#stockprice td').css('white-space','initial');
});