...
class CouponController extends Controller
{
    ...
    public function coupons()
        ...
        // dd($data);
        return view('seller.benefits.coupons.list',$data);
        }
        ...
        $data['sellers']      =    Store::where('is_active',1)->where(function ($query) { $query->where('is_deleted', '=', NULL)->orWhere('is_deleted', '=', 0);})->get();
        // dd($data);
        return view('seller.benefits.coupons.create',$data);
        }
    ...
    function subtree($cateid,$subid,$selectid='')
    {
      ...
      return $jj;
        ...
        $data['sellers']      =    Store::where('is_active',1)->where(function ($query) { $query->where('is_deleted', '=', NULL)->orWhere('is_deleted', '=', 0);})->get();
        // dd($data);
        return view('seller.benefits.coupons.edit',$data);
        }
        ...
        // dd($data);
         ...
         return view('seller.benefits.coupons.logs',$data);
        }
