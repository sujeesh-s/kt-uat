...
class Modules extends Model
{
    ...
    public $table = 'usr_seller_module';
   ...
   $query->select('module_id')->from('usr_seller_role_action')->where('usr_role_id',$role)->where('is_active',1)->where('view',1);
...
// dd($modules);
    ...
    static function visibleModules($role){ 
        ...
        $query->select('module_id')->from('usr_seller_role_action')->where('usr_role_id',$role)->where('is_active',1)->where("$act",1);
