...
'valid_from','valid_to','valid_days','is_active','is_deleted','created_by','user_type','updated_by','created_at','updated_at'];
        ...
        static function getCoupons($cpn=''){ 
           ...
           $cpn_list = Coupon::where(function ($query) { $query->where('is_deleted', '=', NULL)->orWhere('is_deleted', '=', 0);})->where('created_by',auth()->user()->id)->where('user_type','seller')->orderBy('id', 'DESC')->get();     
            }
