                ...
                <div class="col-md-6">
                    <div class="">
                        <div class="text-white">
                            <div class="card-body">
                                <h2 class="display-4 mb-2 font-weight-bold error-text text-center"><strong>Create Password</strong></h2>
                                <form method="POST" action="{{ url('create/password') }}" id="updatePass">
                                @csrf
                                <div class="row">
                                    <div class="col-9 d-block mx-auto">
                                        
                                           
                                            <input id="email" type="hidden" class="form-control" name="email" value="{{$reset->email}}" placeholder="Email" title="Enter Email" required />
