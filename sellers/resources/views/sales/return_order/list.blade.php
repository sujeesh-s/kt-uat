...
<div id="content_list">@include('sales.return_order.list.content')</div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('click','#accept_btn',function(){ 
            var id          =   $(this).data('val');  
            var status      =   'accepted';
            var url         =   '{{url("sales/order/return/updateStatus")}}';
            var smsg        =   'Request '+status+' successfully!';
            var desc        =   'Return order accepted by Seller';
            swal({
        ...
        $('body').on('click','#reject_btn',function(){ 
            ...
            var url         =   '{{url("sales/order/return/updateStatus")}}';
            var smsg        =   'Request '+status+' successfully!';
            var desc        =   'Return order rejected by Seller';
            swal({
