            ...
            {{ Form::open(array('url' => "my-products/product/save", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                ...
                <div class="row panel-body tabs-menu-body">
                    <div class="tab-content col-12">
                        @include('seller.my_products.view.general')
                        @include('seller.my_products.view.price_tax')
                        @include('seller.my_products.view.image')
                        @include('seller.my_products.view.attribute')
                         @include('seller.my_products.view.reviews')
                    </div>
                </div>
                <div class="col-lg-12">
