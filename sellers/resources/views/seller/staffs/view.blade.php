...
@section('content')
        ...
        <div >
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                   ...
                   <p class="view_value">{{ $seller->lname }} </p>
            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <p class="view_value">{{ $seller->email }} </p>
                    
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label view" for="phone">Phone: </label>
                 
                    <p class="view_value">{{ $seller->phone }} </p> 
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <p class="view_value">@if($seller->is_active ==1){{ "Active" }}@else{{ "Inactive" }}@endif</p>
                </div>
                <div class="col-md-6 mb-3">
			...
			@php
			$role_data =DB::table('usr_seller_role_lk')->where('id', $seller->staff_role_id)->first();
			if($role_data){ 
        ...
        <div >
                     <div class="row" style="margin-top: 30px;">
															...
															<a href="{{url('/staff-list')}}"  class="mr-2 btn btn-secondary" >Back</a>           
