...
@section('page-header')
				...
				<div class="page-rightheader" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
								...
								<div class="btn btn-list">
									...
									<a href="{{ url('/staff-list/create') }}"   class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
								</div>
							</div>
						</div>
                        <!--End Page header-->
																...
																<tr>
																	...
																	<td class="align-middle" >
																	    ...
																	    <div class="d-flex">
																			...
																			<div class="ml-3 mt-1">
																				<h6 class=" font-weight-bold"><a href="{{ url('staff-list/view/') }}/{{$row->id}}" >{{ $row->fname." ".$row->lname }} </a></h6>
																			</div>
																		</div>
																	
																	</td>
																	<td class="text-nowrap align-middle">
																		<p>{{$row->staffMst->teleEmail->value}}</p>
																	</td>
																	<td class="text-nowrap align-middle">
																		<p>{{$row->staffMst->telePhone->value}}</p>
																	</td>
																	<td class="text-nowrap align-middle">
																	@php
																	$role_data =DB::table('usr_seller_role_lk')->where('id', $row->staff_role_id)->first();
																	if($role_data){ 
...
<span class="switch-inactive" aria-hidden="true">Inactive</span>
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			    	@if(checkPermission('/staff-list','edit') == true)
																			<a href="{{ url('staff-list/edit/') }}/{{$row->id}}"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
																				@endif
																			@if( $row->role_id !=1 ) 
																			@if(checkPermission('/staff-list','delete') == true)
