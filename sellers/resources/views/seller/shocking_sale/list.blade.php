											...
											<div class="card-body">
												<div class="e-table">
													<div class="table-responsive table-lg mt-3">
														<table class="table table-bordered border-top shockingsales" id="shockingsales">
															<thead>
																<tr>
																	...
																	<th class="border-bottom-0 w-20">Products</th>
																...
																<tr>
																	...
																	<td class="" >
																		...
																		<div class="btn-group align-top">
																			@php $disabled_status = 1; @endphp
																			@if($row['expired'] ==1)
																			<a   class="mr-2 btn btn-primary btn-sm  fixed-btn">Sale Expired</a>
																			@else
																			<a href="{{ url('/shocking-sales/create/') }}/{{$row['id']}}"   class="mr-2 btn btn-info btn-sm editmodule fixed-btn"><i class="fe fe-plus mr-1"></i>Add Product</a>
																			@endif
																	...
																	<label class="switch-paddle" for="status-{{$row['prd_sale_id']}}">
