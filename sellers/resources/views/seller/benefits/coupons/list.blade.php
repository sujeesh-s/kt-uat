						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<div class="btn btn-list">
									...
									<a href="{{ url('/coupons/create/') }}"  class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
								</div>
							</div>
													...
													?>		
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			...
																			<a href="{{ url('/coupons/log/') }}/{{$row['id']}}"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> View</a>
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			...
																			<a href="{{ url('/coupons/edit/') }}/{{$row['id']}}"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
