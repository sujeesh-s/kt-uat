									...
									<div class="tab-menu-heading p-0">
										<div class="tabs-menu1 px-3">
											<ul class="nav">
												...
												<li><a href="#tab-9" data-toggle="tab" id="ord_hist" class="fs-14">Order/Transaction History</a></li>
												<!--<li><a href="#tab-10" data-toggle="tab" id="trans_hist"  class="fs-14">Transaction History</a></li>-->
											</ul>
										</div>
									</div>
								</div>
											...
											<div class="card">
												<div class="card-body border-top">
													...
													<div class="main-profile-contact-list d-lg-flex">
														...
														@if(! is_null($customer_mst->user_address($customer_mst->id)))
														@foreach($customer_mst->user_address($customer_mst->id) as $address)
														<div class="media mr-5">
															...
															<div class="media-body">
																...
																<h6 class="font-weight-bold mb-1">{{ $address['type'] }} </h6>
									...
									<div class="row mr-0 ml-0">
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
									            ...
									            <h2 class="mb-1 font-weight-bold">{{count($order)}}</h2>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
									            ...
									            <h2 class="mb-1 font-weight-bold">{{$t_amt}}</h2>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
									            ...
									            <h2 class="mb-1 font-weight-bold">{{count($cancelled_order)}}</h2>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
									            ...
									            <h2 class="mb-1 font-weight-bold">@if(!empty($refunded_order))
													@php
													$tr_amt=0;
													foreach($refunded_order as $key)
													{
													    $tr_amt +=$key->g_total;
													}
													@endphp
						...
						<!--End row-->
												...
												<div class="e-table">
													<div class="table-responsive table-lg mt-3">
														<table id="order-table" class="order-table table table-striped table-bordered w-100 text-nowrap">
															...
															<tbody>
															    @if($order_hist && count($order_hist) > 0)
                    											@foreach($order_hist as $row)
                    											<tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="d-flex">
                                                                    <h6 class=" font-weight-bold"><a href="{{ url('/customer/invoice/') }}/{{$row->id}}" class="btn btn-sm btn-info">Invoice</a></h6>
                                                                    </div>
                                                                </td>
                                                                </tr>
                                                                 @endforeach
										...
										<div class="tab-pane" id="tab-10">
                                            ...
                                            <div class="card-body">
												<div class="e-table">
													<div class="table-responsive table-lg mt-3">
														<table id="trans-table" class="trans-table table table-striped table-bordered w-100 text-nowrap">
															<thead>
																<tr>
																	<th class="align-top border-bottom-0 wd-5"></th>
															...
															<tbody>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="d-flex">
                                                                    <h6 class=" font-weight-bold">{{$ord_title}}</h6>
                                                                    </div>
                                                                </td>
                                                                <td class="align-middle">
                                                                    <div class="d-flex">
                                                                    <h6 class=" font-weight-bold">{{$credit}}</h6>
                                                                    </div>
                                                                </td>
                                                                <td class="align-middle">
                                                                    <div class="d-flex">
                                                                    <h6 class=" font-weight-bold">{{$debit}}</h6>
                                                                    </div>
                                                                </td>
                                                                <td class="align-middle">
                                                                    <div class="d-flex">
...
<input type="hidden" id="trns_dt" value="0">
...
var transHist = document.getElementById('trans_hist');

transHist.onclick = function(){
var trns_dt = $('#trns_dt').val();
var script = document.createElement("script");
script.type = "text/javascript";
script.src = "{{URL::asset('admin/assets/js/datatable/tables/transtable-datatable.js')}}"; 
if (  trns_dt == 0 ) {
$('#trns_dt').val(1);
document.getElementsByTagName("head")[0].appendChild(script);
}
