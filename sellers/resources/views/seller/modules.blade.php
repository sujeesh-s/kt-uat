...
<div class="btn-group align-top">
     @if(checkPermission('/modules','edit') == true)
...
@endif
 @if(checkPermission('/modules','delete') == true)
									...
									<div class="modal-dialog modal-lg" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												{{ Form::open(array('url' => "modules/save", 'id' => 'userForm', 'name' => 'userForm', 'class' => '','files'=>'true')) }}
