						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<div class="btn btn-list">
									...
									<a href="{{ url('/user-roles/create') }}"   class="btn btn-primary addmodule"><i class="fe fe-plus mr-1"></i> Add New</a>
								</div>
							</div>
						</div>
                        <!--End Page header-->
																...
																<tr>
																	...
																	<td class="align-middle" >
																		<div class="d-flex">
																				...
																				<h6 class=" font-weight-bold"><a href="{{ url('/user-roles/view/') }}/{{$row['id']}}"> {{$row['usr_role_name']}}</a></h6>
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			@if($row['id'] !=1)
																		@if(checkPermission('//user-roles','edit') == true)
																		<a href="{{ url('/user-roles/edit/') }}/{{$row['id']}}"   class="mr-2 btn btn-info btn-sm editmodule"><i class="fe fe-edit mr-1"></i> Edit</a>
																		@endif
																		@if(checkPermission('/user-roles','delete') == true)
