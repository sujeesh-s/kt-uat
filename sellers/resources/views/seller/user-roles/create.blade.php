						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item " aria-current="page"><a href="{{url('/user-roles')}}">User Roles</a></li>
...
{{ Form::open(array('url' => "/user-roles/save", 'id' => 'userForm', 'name' => 'userForm', 'class' => '','files'=>'true')) }}
																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			...
																			{!! Form::text('usr_role_name', null, ['class' => 'form-control','id'=>'usr_role_name']) !!}
																		</div>
																	@error('usr_role_name')
																...
																<div class="row">
																	<div class="col mb-3">
																		<div class="form-group">
																			...
																			{!! Form::textarea('usr_role_desc', null, ['class' => 'form-control','id'=>'usr_role_desc', 'rows' => '3']) !!}
																		</div>
																	@error('usr_role_desc')
																	<p style="color: red">{{ $message }}</p>
																	@enderror
 ...
 @if($modules && count($modules) > 0)
    ...
    <input class=' switch-input status-btn ser_status' name="modules[{{$pt['id']}}]['view']" data-selid="{{$pt['id']}}" id="view-{{$pt['id']}}" value="1"  type="checkbox" />
    ...
    <span class="switch-inactive" aria-hidden="true">Inactive</span>
		...
		<input class='switch-input status-btn ser_status' name="modules[{{$pt['id']}}]['edit']" id="edit-{{$pt['id']}}" data-selid="{{$pt['id']}}" value="1"  type="checkbox"  />
		...
		<input class=' switch-input status-btn ser_status' name="modules[{{$pt['id']}}]['delete']" id="delete-{{$pt['id']}}" data-selid="{{$pt['id']}}" value="1"  type="checkbox"  />
                                ...
                                @foreach($child as $ch) 
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-2 sub-title {{$nrow}} citems">
                                       						<div class="switch viewbox">
		<input class='switch-input status-btn ser_status' name="modules[{{$ch['id']}}]['view']" id="ch-view-{{$ch['id']}}" data-selid="{{$ch['id']}}" value="1"  type="checkbox"  />
		...
		<span class="switch-inactive" aria-hidden="true">Inactive</span>
								...
								<div class="col-2 sub-title {{$nrow}} citems">
									<div class="switch editbox">
		<input class='switch-input status-btn ser_status' name="modules[{{$ch['id']}}]['edit']" data-selid="{{$ch['id']}}" id="ch-edit-{{$ch['id']}}" value="1"  type="checkbox"  />
		...
		<span class="switch-inactive" aria-hidden="true">Inactive</span>
								...
								<div class="col-2 sub-title {{$nrow}} citems">
										<div class="switch deletebox">
		<input class='switch-input status-btn ser_status' name="modules[{{$ch['id']}}]['delete']" id="ch-delete-{{$ch['id']}}" data-selid="{{$ch['id']}}" value="1"  type="checkbox" />
                ...
                @endif
														...
														<div class="row" style="margin-top: 30px;">
															<div class="col d-flex justify-content-end">
															    <a href="{{url('/user-roles')}}"  class="mr-2 btn btn-secondary" >Cancel</a>  
