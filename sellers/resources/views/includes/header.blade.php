										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="{{url('/' . $page='#')}}" class="dropdown-item text-center user pb-0 font-weight-bold">{{sellerData()->fname.' '.sellerData()->lname}}</a>
													<span class="text-center user-semi-title">{{roleData()->usr_role_name}}</span>
													<div class="dropdown-divider"></div>
												</div>
											@if(auth()->user()->role_id ==3)	<a class="dropdown-item d-flex" href="{{url('/profile')}}">
												...
												<a class="dropdown-item d-flex" href="{{url('/seller/logout')}}">
