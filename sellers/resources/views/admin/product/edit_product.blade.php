                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php $default_lang =DB::table('glo_lang_lk')->where('is_active', 1)->first();
                                                                    $product_name=DB::table('cms_content')->where('cnt_id', $product->name_cid)->where('lang_id', $default_lang->id)->first();?>
                                                                <input type="text" class="form-control @error('product_name') is-invalid @enderror" placeholder="Product Name" name="product_name" value="{{ $product_name->content }}">
                                                                @error('product_name')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Short Description <span class="text-red">*</span></label>
                                                                 <?php $default_lang =DB::table('glo_lang_lk')->where('is_active', 1)->first();
                                                                    $sdesc=DB::table('cms_content')->where('cnt_id', $product->short_desc)->where('lang_id', $default_lang->id)->first();?>
                                                                <textarea rows="1" class="form-control @error('short_description') is-invalid @enderror" placeholder="Short Description about the product" name="short_description" >{{$sdesc->content}}</textarea>
                                                        ...
                                                        <div class="col-sm-6 col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                @foreach($prod_type as $type )
                                                                    <option value="{{$type->id}}" @if($type->id==$product->product_type){{"selected"}}@endif>{{$type->type_name}}</option>
                                                                 @endforeach
                                                                </select>
                                                                @error('product_type')
                                                                    <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <?php if($product->desc!=''){$ldesc=DB::table('cms_content')->where('cnt_id', $product->desc)->where('lang_id', $default_lang->id)->first();
                                                                $ldesc_content=$ldesc->content;
                                                                }else{$ldesc_content='';}?>
                                                                <textarea class="content" name="long_description" >{{$ldesc_content}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Content <span class="text-red"></span></label>
                                                                <?php if($product->content!=''){$content=DB::table('cms_content')->where('cnt_id', $product->content)->where('lang_id', $default_lang->id)->first();
                                                                $cont_content=$content->content;
                                                                }else{$cont_content='';}?>
                                                                <textarea class="content2" name="content">{{$cont_content}}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <br>
                                                        <?php $image_product =DB::table('prod_image')->where('prod_id', $product->id)->get(); ?>
                                                        @if($image_product)
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                        ...
                                                        @foreach($image_product as $imgprd)
                                                            <div class="d-flex">
                                                                <span class="pip">
                                                                <img src="{{ url('storage/app/public/product/'.$imgprd->image) }}" alt="{{ $imgprd->image }}" class="imageThumb">
