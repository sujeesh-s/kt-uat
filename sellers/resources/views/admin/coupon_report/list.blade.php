                    ...
                    <div id="data-content" class="card-body">
                        ...
                        <div id="table_body" class="card-body table-card-body">
                            <div class="table-responsive">
                                    ...
                                    <tr>    
                                        <td><label class="custom-control custom-checkbox"></label></td>
                                        <td>
                                        ...
                                        <!--</td>-->
                                        <td>{{$row->coupon->getCpnContent($row->coupon->cpn_title_cid)}} & <b>{{$row->coupon->ofr_code}}</b></td>
                                        <td> {{$row->coupon->ofr_type}}</td>
                                        <td>{{$row->users}}</td>
                                        <td>{{$row->purchase}}</td>
                                        <td>{{$row->discount}}</td>
                                    </tr>
