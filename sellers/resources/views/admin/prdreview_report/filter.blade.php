        ...
        <div class="col-3 fl">
            <div class="page-filters">
                ...
                <select class="form-control" id="product">
                    ...
                    <option value="{{$rows->id}}">{{$rows->get_content($rows->name_cnt_id)}}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
<div id="content_list">@include('admin.prdreview_report.list')</div>
...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("report/product-review-report")}}',
        ...
        $('body').on('click','.viewBtn',function(){
            ...
            $.ajax({
                type: "GET",
               url: '{{url("report/product-review-report")}}/'+id+"/view",
                success: function (data) {
