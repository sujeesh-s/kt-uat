...
<script>
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('change','#start_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("report/product-visit")}}',
                data: {start_date: this.value, end_date: $('#end_date').val(),product: $('#product').val(),viewType: 'ajax'},
        ...
        $('body').on('change','#end_date',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("report/product-visit")}}',
                data: {end_date: this.value, start_date: $('#start_date').val(),product: $('#product').val(),viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
        ...
        $('body').on('change','#product',function(){  
            ...
            $.ajax({
                type: "POST",
                url: '{{url("report/product-visit")}}',
                data: {start_date: $('#start_date').val(),end_date: $('#end_date').val(),product: this.value,viewType: 'ajax'},
                success: function (data) {
                    $('#content_list').html(data); 
                } 
            });
