                                            ...
                                            @foreach($settlements as $row) @php $n++; @endphp
                                                ...
                                                <tr class="dtrow" id="dtrow-{{$row->id}}">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button id="payBtn-{{$row->id}}" class="mr-2 btn btn-success btn-sm payBtn" data-page="earnings" data-seller="{{$row->seller_id}}" data-toggle="modal" data-target=".bd-example-modal-sm">Make Payment</button>
                                                    </td>
                                            @endforeach
                                        @endif
                                    </tbody>
