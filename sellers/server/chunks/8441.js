...
const MarketPlaceDealOfDay = ({
  ...
  async function getProducts() {
    setLoading(true);
    const responseData = await (0,_utilities_strapi_fetch_data_helpers__WEBPACK_IMPORTED_MODULE_6__/* .getProductsByCollectionHelper */ .l)(collectionSlug);
...
/* harmony default export */ __webpack_exports__["Z"] = (MarketPlaceDealOfDay);
