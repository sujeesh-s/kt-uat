     ...
     //main banner
       ...
       foreach($category_data as $key)
        ...
        return ['httpcode'=>200,'status'=>'success','message'=>'Success','data'=>['user_data'=>$user,'main_banner'=>$main_array,
            ...
            'category'=>$categories,'featured_products'=>$products,'daily_deals'=>$daily_product,'cat_subcat'=>$cat_subcat,'shocking_sale'=>$shock_data,'auction'=>$auction_data,'sellers'=>$store_data,'languages'=>$language,'cart'=>$cart,'most_searched'=>$most_search,'most_search_brand'=>$search_brand]];
    }
